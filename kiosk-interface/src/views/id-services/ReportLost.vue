    ...
    <div class="flex-1 mb-4 flex flex-col">
      ...
      >
        ...
        <div
          ...
          class="flex-1 w-full flex flex-row gap-8 items-stretch justify-center animate-fadeIn"
        >
          <div class="flex-1">
            <div
              class="bg-red-50 p-8 rounded-2xl border border-red-200 flex flex-col h-full shadow-lg"
            >
              <div class="flex-1">
          ...
          <div class="flex-1">
            <div
              class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 flex flex-col items-center h-full justify-center"
            >
              ...
              <div class="grid grid-cols-3 gap-3 w-full">
                <button
                  ...
                  class="h-14 rounded-2xl bg-gray-100 text-[#03335C] text-2xl font-bold border border-gray-100 active:bg-gray-200 transition-colors"
                >
                  {{ n }}
                </button>
                <div class="h-14"></div>
