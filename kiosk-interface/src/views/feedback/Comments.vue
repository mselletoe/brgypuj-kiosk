<template>
  <div class="feedback-layout">
    ...
    <div class="rating-display-wrapper">
        ...
        <template v-for="n in Number(starCount)">
...
<style scoped>
.feedback-layout{display:flex;flex-direction:column;align-items:center;width:100%;height:100%;overflow:hidden;background-color:#ffffff;font-family:'Poppins';color:#003a6b;box-sizing:border-box;padding:0px 20px 0px 20px;}
...
.rating-display-wrapper {display: flex;align-items: center;justify-content: center;margin-bottom: 23px;width: 100%;}
...
.additional-title-wrapper {display: flex;align-items: center;width: 816px;margin: 0 auto 10px 0;max-width: 100%;}

.comment-icon {width: 24px;height: 24px;margin-right: 5px;margin-left: 20px;}
.additional-title-text{font-size: 13px;margin: 0;text-align: left;color: #003a6b;font-weight: bold;}
.comments-input {width: 816px;height: 200px;background-color: #FFFFFF;border: 2px solid #003A6B;border-radius: 10px;box-shadow: 3px 3px 6px rgba(0, 0, 0, 0.2);font-family: 'Poppins';font-size: 13px;font-weight: regular;color: #003a6b;padding: 15px;resize: none;outline: none;flex-shrink: 0; margin-bottom: 30px;}
.comments-input::placeholder {color: #003a6b; opacity: 1; }

.buttons-container {display: flex;justify-content: space-between;width: 816px;}
