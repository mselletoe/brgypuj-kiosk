 ...
 * @description Admin account settings page to manage profile, security, preferences, and view audit logs.
 */
  ...
  <div class="flex flex-col p-6 bg-white rounded-md w-full h-full overflow-hidden">
    ...
    <div class="flex justify-between items-center border-b border-gray-200">
      ...
      >
        ...
        <n-tab-pane name="Audit Log" tab="Audit Log" />
      </n-tabs>
    </div>

    <div class="overflow-y-auto h-[calc(100vh-200px)] pt-6 pr-2">
      
      <div v-if="activeTab === 'Profile'" class="flex flex-col lg:flex-row gap-12 lg:justify-between items-start">
        <div class="flex-1 w-full max-w-2xl flex flex-col gap-6">
          ...
          <div class="flex flex-col gap-2">
            <label class="text-[12px] font-bold text-gray-800">Role/Position</label>
            <n-input 
        ...
        <div class="flex flex-col items-center lg:items-end w-full lg:w-auto lg:mr-12 mt-8 lg:mt-0">
          <div class="flex flex-col w-[320px]">
            <span class="font-['Inter'] font-semibold text-[16px] text-[#373737] mb-6">Profile Photo</span>
      ...
      <div v-if="activeTab === 'Security'" class="flex flex-col lg:flex-row gap-12 lg:justify-between items-start">
        <div class="flex-1 w-full max-w-2xl flex flex-col gap-6">
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2 pt-1">
            ...
            <p class="text-[11px] text-gray-400 mt-1">Password must be at least 8 characters with uppercase, lowercase, and numbers</p>
          </div>
        ...
        <div class="w-full lg:w-[400px] border-2 border-[#B1202A] bg-[#fff5f5] rounded-lg p-6 flex flex-col lg:mr-16">
          <h3 class="font-['Inter'] font-bold text-[16px] text-[#B1202A] mb-2">Delete Account</h3>
          <p class="font-['Inter'] font-normal text-[14px] text-[#000000] mb-6 leading-relaxed">Permanently delete your admin account and all associated data. This action cannot be undone.</p>
          <div class="flex justify-end mt-auto">
            <n-button color="#FF0000" text-color="#FFFFFF" class="font-bold font-['Inter']" @click="handleDeleteAccount">
              Delete Account
            </n-button>
          </div>
        </div>
      ...
      <div v-if="activeTab === 'Preferences'" class="flex flex-col md:flex-row gap-16">
        <div class="flex-1 max-w-md flex flex-col gap-6">
          <h3 class="font-bold text-gray-800 text-[15px]">Notification Settings</h3>
        ...
        <div class="flex-1 max-w-md flex flex-col gap-6">
          <h3 class="font-bold text-gray-800 text-[15px]">Display Preferences</h3>
          
          <div class="flex flex-col gap-2">
            <label class="text-[12px] font-bold text-gray-800">Default Landing Page</label>
            <n-select 
      ...
      <div v-if="activeTab === 'Audit Log'" class="flex flex-col w-full">
            ...
            <tbody>
              <tr v-for="(log, index) in auditLogs" :key="index" class="border-b border-gray-100 last:border-none hover:bg-gray-50 transition-colors">
                <td class="py-4 px-4 whitespace-nowrap flex flex-col">
                  <span class="text-[13px] text-gray-800">{{ log.date }}</span>
