...
<template>
  ...
  >
    ...
    <div class="flex flex-col items-center justify-center space-y-1">
      <div
        class="flex justify-center bg-blue-50 border border-blue-200 rounded px-4 py-1 min-w-[90px]"
      >
        <div class="text-lg font-bold text-blue-900 leading-tight">
          {{ transactionNo }}
        </div>
      </div>
        ...
        <template v-for="btn in visibleButtons" :key="btn.id">
          ...
          >
            ...
            <div class="w-80 p-3 space-y-3">
              <h3
                class="text-sm font-bold text-slate-800 mb-3 pb-2 border-b border-gray-200"
              >
                Request Details
              </h3>
              ...
              <div class="space-y-3">
                <!-- Contact Person -->
                <div class="flex flex-col">
                  <span class="text-xs text-gray-500 font-medium mb-1"
                    >Contact Person</span
                  >
