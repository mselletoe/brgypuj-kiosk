<script setup>
/**
 * @file views/requests/equipment-requests/subtabs/PickedUpTab.vue
 * @description Displays and manages Equipment requests that are currently Picked Up (Borrowed).
 * Supports search, filters, mark as returned, SMS reminders, undo, delete, and bulk actions.
