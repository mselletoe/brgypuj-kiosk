  ...
  >
    ...
    <div class="grid grid-cols-2 gap-4">
      <button
        ...
        class="quick-action-btn flex items-center gap-3 p-2 rounded-[14px] border border-gray-100 bg-gray-50 transition-all duration-200 cursor-pointer text-left group h-[60px]"
