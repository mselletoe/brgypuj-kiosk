...
class Resident(Base):
    ...
    residency_start_date = Column(Date, server_default=func.current_date())
    ...
    admin_account = relationship("Admin", back_populates="resident", uselist=False)
...
class Address(Base):
    ...
    barangay = Column(String(64), default="YourBarangay")
    municipality = Column(String(16), default="YourCity")
    province = Column(String(16), default="YourProvince")
    region = Column(String(64), default="Region III")
